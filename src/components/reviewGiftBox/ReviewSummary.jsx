  ...
  return (
    <section className="mt-12 space-y-8">
      ...
      <div className="rounded-[32px] bg-white p-8 shadow-lg">
        <h2 className="text-2xl font-bold text-[#2E1E13]">Selected Products</h2>
      ...
      <div className="rounded-[32px] bg-white p-8 shadow-lg">
        <h2 className="text-2xl font-bold text-[#2E1E13]">Recipient Details</h2>

        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div>
            <p className="text-sm text-gray-500">Recipient Name</p>

            <h3 className="mt-1 text-lg font-semibold">{recipient.name}</h3>
          </div>

          <div>
            <p className="text-sm text-gray-500">Occasion</p>

            <h3 className="mt-1 text-lg font-semibold">{recipient.occasion}</h3>
          </div>
        </div>
      ...
      <div className="rounded-[32px] bg-[#2E1E13] p-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-white/70">Estimated Total</p>
          ...
          <div className="text-right">
            ...
            <p className="mt-2 text-sm text-white/60">Ready for Checkout</p>
          </div>
        </div>
      </div>
    </section>
